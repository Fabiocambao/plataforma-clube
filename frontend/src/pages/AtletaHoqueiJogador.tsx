      ...
      <div className="w-full max-w-screen-xl px-4 space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-xl shadow p-4">
              <p className="text-sm text-gray-500">Golos Marcados ⚫</p>
              <h2 className="text-2xl font-bold text-gray-800 mt-1">15</h2>
              <p className="text-xs text-green-600 mt-1">+2 em relação à última temporada</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow p-4">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mt-1">65%</h2>
              <p className="text-xs text-green-600 mt-1">+5% em relação à última temporada</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 min-h-[250px]">
            <div className="bg-white p-5 rounded-xl shadow">
              <h2 className="text-md font-semibold text-gray-700 mb-2">Golos + Assistências Por Jogo</h2>
...
export default AtletaHoqueiJogador;
