...
const CoordenadorBasquetebol = () => {
  ...
  useEffect(() => {
    ...
    const guardadas = JSON.parse(localStorage.getItem('estatisticas_basquetebol') || '[]');
    setEstatisticas(guardadas);

    // Carregar escalões
    const escalas = ['Sub-19', 'Sub-21', 'Seniores']; // Exemplo
    setEscaloes(escalas);
  }, []);
  ...
  const handleSaveEstatistica = () => {
    ...
    localStorage.setItem('estatisticas_basquetebol', JSON.stringify(novasEstatisticas));
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-screen-xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-semibold text-gray-800">Estatísticas de Basquetebol</h1>
...
export default CoordenadorBasquetebol;
